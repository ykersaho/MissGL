...
Java_yk_missgl_MISObject_addnativeobject(JNIEnv *env, jobject instance, jstring name_,
...
extern "C"
JNIEXPORT void JNICALL
Java_yk_missgl_MISObject_updatenativeobject(JNIEnv *env, jobject instance, jstring name_,
...
Java_yk_missgl_MISObject_getpositionspeed(JNIEnv *env, jobject instance, jstring name_)
{
    jfloatArray result;
...
extern "C"
JNIEXPORT jfloatArray  JNICALL
Java_yk_missgl_MISObject_getrotationaxis(JNIEnv *env, jobject instance, jstring name_)
{
    jfloatArray result;
...
extern "C"
JNIEXPORT jfloatArray  JNICALL
Java_yk_missgl_MISObject_getrotationcenter(JNIEnv *env, jobject instance, jstring name_)
{
    jfloatArray result;
...
Java_yk_missgl_MISObject_getrotationspeed(JNIEnv *env, jobject instance, jstring name_)
{
    const char *name = env->GetStringUTFChars(name_, 0);
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_yk_missgl_MISObject_getrotationacceleration(JNIEnv *env, jobject instance, jstring name_)
{
    const char *name = env->GetStringUTFChars(name_, 0);
...
Java_yk_missgl_MISObject_getcollisionstate(JNIEnv *env, jobject instance, jstring name_)
{
    const char *name = env->GetStringUTFChars(name_, 0);
...
extern "C"
JNIEXPORT void JNICALL
Java_yk_missgl_MISCollision_collision__(JNIEnv *env, jobject instance) {
